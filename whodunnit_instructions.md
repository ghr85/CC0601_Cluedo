...
```
*In this scenario there will be two separate outputs firstly implicating Miss Scarlet, Professor Plum & colonel mustard as number 3 as the constant suspects calls the function declare all suspects where suspect 3 has been changed within its limited block scope. The second output will identify suspect three as Mrs Peacock as suspect 3 remains unchanged outside the block*
